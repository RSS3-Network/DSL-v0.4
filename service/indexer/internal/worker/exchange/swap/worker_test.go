...
func TestName(t *testing.T) {
	ethereumClient, err := ethclient.Dial("https://lively-fragrant-violet.bsc.quiknode.pro/2982b3556dd63ee0dd702052ca2d72199562eb27")
	if err != nil {
		t.Fatalf("failed to connect to ethereum client: %v", err)
	}

	transaction, _, err := ethereumClient.TransactionByHash(context.Background(), common.HexToHash("0x7757effaa4c0915146a039a1f5cc6c9f8046cb252b0428e3e2062954a762fb2a"))
	if err != nil {
