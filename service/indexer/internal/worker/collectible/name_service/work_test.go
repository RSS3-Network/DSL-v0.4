...
func Test_worker_Handle(t *testing.T) {
	...
	testcases := []struct {
		...
		{
			name: "ens text changed v1",
			arguments: arguments{
				ctx: context.Background(),
				message: &protocol.Message{
					Address: "0x4f35f7ec953d61d77329e2cc82d032c332f84473",
					Network: protocol.NetworkEthereum,
				},
				transactions: []model.Transaction{
					{
						// https://etherscan.io/tx/0x8cebeb1cd875fba3fe03f4b07ba01ada886da2cd24a0ee976f4d67bdabfc9832
						Hash:        "0x8cebeb1cd875fba3fe03f4b07ba01ada886da2cd24a0ee976f4d67bdabfc9832",
						BlockNumber: 17134061,
						Network:     protocol.NetworkEthereum,
					},
				},
			},
		...
		{
			name: "ens text changed v2",
			arguments: arguments{
				ctx: context.Background(),
				message: &protocol.Message{
					Address: "0xa60e522c5517b05526ee0f7f3885b82b37ceeb2d",
					Network: protocol.NetworkEthereum,
				},
				transactions: []model.Transaction{
					{
						// https://etherscan.io/tx/0x7364fd343c669e29af6710ebc55c4e6588e8acb7d2b63afe2a00f09f1528ada8
						Hash:        "0x7364fd343c669e29af6710ebc55c4e6588e8acb7d2b63afe2a00f09f1528ada8",
						BlockNumber: 17134061,
						Network:     protocol.NetworkEthereum,
					},
				},
