...
var ErrorInvalidMetadataFormat = errors.New("invalid metadata format")

type Client struct{}

func (c *Client) GetMetadata(projectId, network string, contractAddress common.Address, tokenID *big.Int) ([]byte, error) {
	ethereumEndpoint := ""
