...
var (
	...
	EventHashCollectNFTTransferred = crypto.Keccak256Hash([]byte("CollectNFTTransferred(uint256,uint256,uint256,address,address,uint256)"))
)
...
var SupportLensEvents = map[common.Hash]common.Address{
	...
	EventHashCollectNFTTransferred: HubProxyContractAddress,
}
