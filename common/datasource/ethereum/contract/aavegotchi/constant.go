...
//go:generate go run -mod=mod github.com/ethereum/go-ethereum/cmd/abigen ./contract/ERC1155MarketplaceFacet.abi --pkg contract --type ERC1155Marketplace --out ./contract/ERC1155MarketplaceFacet.go
//go:generate go run -mod=mod github.com/ethereum/go-ethereum/cmd/abigen ./contract/ERC721MarketplaceFacet.abi --pkg contract --type ERC721Marketplace --out ./contract/ERC721MarketplaceFacet.go
//go:generate go run -mod=mod github.com/ethereum/go-ethereum/cmd/abigen ./contract/AavegotchiGameFacets.abi --pkg contract --type Game --out ./contract/AavegotchiGameFacets.go
