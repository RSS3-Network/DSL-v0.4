...
func (_Position *PositionCaller) DOMAINSEPARATOR(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "DOMAIN_SEPARATOR")
...
//
// Solidity: function DOMAIN_SEPARATOR() view returns(bytes32)
func (_Position *PositionSession) DOMAINSEPARATOR() ([32]byte, error) {
	return _Position.Contract.DOMAINSEPARATOR(&_Position.CallOpts)
}

// DOMAINSEPARATOR is a free data retrieval call binding the contract method 0x3644e515.
//
// Solidity: function DOMAIN_SEPARATOR() view returns(bytes32)
func (_Position *PositionCallerSession) DOMAINSEPARATOR() ([32]byte, error) {
	return _Position.Contract.DOMAINSEPARATOR(&_Position.CallOpts)
}
...
func (_Position *PositionCaller) PERMITTYPEHASH(opts *bind.CallOpts) ([32]byte, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "PERMIT_TYPEHASH")
...
//
// Solidity: function PERMIT_TYPEHASH() view returns(bytes32)
func (_Position *PositionSession) PERMITTYPEHASH() ([32]byte, error) {
	return _Position.Contract.PERMITTYPEHASH(&_Position.CallOpts)
}

// PERMITTYPEHASH is a free data retrieval call binding the contract method 0x30adf81f.
//
// Solidity: function PERMIT_TYPEHASH() view returns(bytes32)
func (_Position *PositionCallerSession) PERMITTYPEHASH() ([32]byte, error) {
	return _Position.Contract.PERMITTYPEHASH(&_Position.CallOpts)
}
...
func (_Position *PositionCaller) WETH9(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "WETH9")
...
//
// Solidity: function WETH9() view returns(address)
func (_Position *PositionSession) WETH9() (common.Address, error) {
	return _Position.Contract.WETH9(&_Position.CallOpts)
}

// WETH9 is a free data retrieval call binding the contract method 0x4aa4a4fc.
//
// Solidity: function WETH9() view returns(address)
func (_Position *PositionCallerSession) WETH9() (common.Address, error) {
	return _Position.Contract.WETH9(&_Position.CallOpts)
}
...
func (_Position *PositionCaller) BaseURI(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "baseURI")
...
//
// Solidity: function baseURI() pure returns(string)
func (_Position *PositionSession) BaseURI() (string, error) {
	return _Position.Contract.BaseURI(&_Position.CallOpts)
}

// BaseURI is a free data retrieval call binding the contract method 0x6c0360eb.
//
// Solidity: function baseURI() pure returns(string)
func (_Position *PositionCallerSession) BaseURI() (string, error) {
	return _Position.Contract.BaseURI(&_Position.CallOpts)
}
...
func (_Position *PositionCaller) Factory(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "factory")
...
//
// Solidity: function factory() view returns(address)
func (_Position *PositionSession) Factory() (common.Address, error) {
	return _Position.Contract.Factory(&_Position.CallOpts)
}

// Factory is a free data retrieval call binding the contract method 0xc45a0155.
//
// Solidity: function factory() view returns(address)
func (_Position *PositionCallerSession) Factory() (common.Address, error) {
	return _Position.Contract.Factory(&_Position.CallOpts)
}
...
func (_Position *PositionCaller) Name(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "name")
...
//
// Solidity: function name() view returns(string)
func (_Position *PositionSession) Name() (string, error) {
	return _Position.Contract.Name(&_Position.CallOpts)
}

// Name is a free data retrieval call binding the contract method 0x06fdde03.
//
// Solidity: function name() view returns(string)
func (_Position *PositionCallerSession) Name() (string, error) {
	return _Position.Contract.Name(&_Position.CallOpts)
}
...
func (_Position *PositionCaller) Positions(opts *bind.CallOpts, tokenId *big.Int) (struct {
	Nonce                    *big.Int
	...
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "positions", tokenId)
...
//
// Solidity: function positions(uint256 tokenId) view returns(uint96 nonce, address operator, address token0, address token1, uint24 fee, int24 tickLower, int24 tickUpper, uint128 liquidity, uint256 feeGrowthInside0LastX128, uint256 feeGrowthInside1LastX128, uint128 tokensOwed0, uint128 tokensOwed1)
func (_Position *PositionSession) Positions(tokenId *big.Int) (struct {
	Nonce                    *big.Int
	Operator                 common.Address
	Token0                   common.Address
	Token1                   common.Address
	...
	return _Position.Contract.Positions(&_Position.CallOpts, tokenId)
}

// Positions is a free data retrieval call binding the contract method 0x99fbab88.
//
// Solidity: function positions(uint256 tokenId) view returns(uint96 nonce, address operator, address token0, address token1, uint24 fee, int24 tickLower, int24 tickUpper, uint128 liquidity, uint256 feeGrowthInside0LastX128, uint256 feeGrowthInside1LastX128, uint128 tokensOwed0, uint128 tokensOwed1)
func (_Position *PositionCallerSession) Positions(tokenId *big.Int) (struct {
	Nonce                    *big.Int
	Operator                 common.Address
	Token0                   common.Address
	Token1                   common.Address
...
func (_Position *PositionCaller) Symbol(opts *bind.CallOpts) (string, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "symbol")
...
//
// Solidity: function symbol() view returns(string)
func (_Position *PositionSession) Symbol() (string, error) {
	return _Position.Contract.Symbol(&_Position.CallOpts)
}

// Symbol is a free data retrieval call binding the contract method 0x95d89b41.
//
// Solidity: function symbol() view returns(string)
func (_Position *PositionCallerSession) Symbol() (string, error) {
	return _Position.Contract.Symbol(&_Position.CallOpts)
}
...
func (_Position *PositionCaller) TokenURI(opts *bind.CallOpts, tokenId *big.Int) (string, error) {
	var out []interface{}
	err := _Position.contract.Call(opts, &out, "tokenURI", tokenId)
...
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_Position *PositionSession) TokenURI(tokenId *big.Int) (string, error) {
	return _Position.Contract.TokenURI(&_Position.CallOpts, tokenId)
}

// TokenURI is a free data retrieval call binding the contract method 0xc87b56dd.
//
// Solidity: function tokenURI(uint256 tokenId) view returns(string)
func (_Position *PositionCallerSession) TokenURI(tokenId *big.Int) (string, error) {
	return _Position.Contract.TokenURI(&_Position.CallOpts, tokenId)
}
...
func (_Position *PositionTransactor) Burn(opts *bind.TransactOpts, tokenId *big.Int) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "burn", tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) payable returns()
func (_Position *PositionSession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Position.Contract.Burn(&_Position.TransactOpts, tokenId)
}

// Burn is a paid mutator transaction binding the contract method 0x42966c68.
//
// Solidity: function burn(uint256 tokenId) payable returns()
func (_Position *PositionTransactorSession) Burn(tokenId *big.Int) (*types.Transaction, error) {
	return _Position.Contract.Burn(&_Position.TransactOpts, tokenId)
}
...
func (_Position *PositionTransactor) Collect(opts *bind.TransactOpts, params INonfungiblePositionManagerCollectParams) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "collect", params)
}

// Collect is a paid mutator transaction binding the contract method 0xfc6f7865.
//
// Solidity: function collect((uint256,address,uint128,uint128) params) payable returns(uint256 amount0, uint256 amount1)
func (_Position *PositionSession) Collect(params INonfungiblePositionManagerCollectParams) (*types.Transaction, error) {
	return _Position.Contract.Collect(&_Position.TransactOpts, params)
}

// Collect is a paid mutator transaction binding the contract method 0xfc6f7865.
//
// Solidity: function collect((uint256,address,uint128,uint128) params) payable returns(uint256 amount0, uint256 amount1)
func (_Position *PositionTransactorSession) Collect(params INonfungiblePositionManagerCollectParams) (*types.Transaction, error) {
	return _Position.Contract.Collect(&_Position.TransactOpts, params)
}
...
func (_Position *PositionTransactor) CreateAndInitializePoolIfNecessary(opts *bind.TransactOpts, token0 common.Address, token1 common.Address, fee *big.Int, sqrtPriceX96 *big.Int) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "createAndInitializePoolIfNecessary", token0, token1, fee, sqrtPriceX96)
}

// CreateAndInitializePoolIfNecessary is a paid mutator transaction binding the contract method 0x13ead562.
//
// Solidity: function createAndInitializePoolIfNecessary(address token0, address token1, uint24 fee, uint160 sqrtPriceX96) payable returns(address pool)
func (_Position *PositionSession) CreateAndInitializePoolIfNecessary(token0 common.Address, token1 common.Address, fee *big.Int, sqrtPriceX96 *big.Int) (*types.Transaction, error) {
	return _Position.Contract.CreateAndInitializePoolIfNecessary(&_Position.TransactOpts, token0, token1, fee, sqrtPriceX96)
}

// CreateAndInitializePoolIfNecessary is a paid mutator transaction binding the contract method 0x13ead562.
//
// Solidity: function createAndInitializePoolIfNecessary(address token0, address token1, uint24 fee, uint160 sqrtPriceX96) payable returns(address pool)
func (_Position *PositionTransactorSession) CreateAndInitializePoolIfNecessary(token0 common.Address, token1 common.Address, fee *big.Int, sqrtPriceX96 *big.Int) (*types.Transaction, error) {
	return _Position.Contract.CreateAndInitializePoolIfNecessary(&_Position.TransactOpts, token0, token1, fee, sqrtPriceX96)
}
...
func (_Position *PositionTransactor) DecreaseLiquidity(opts *bind.TransactOpts, params INonfungiblePositionManagerDecreaseLiquidityParams) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "decreaseLiquidity", params)
}

// DecreaseLiquidity is a paid mutator transaction binding the contract method 0x0c49ccbe.
//
// Solidity: function decreaseLiquidity((uint256,uint128,uint256,uint256,uint256) params) payable returns(uint256 amount0, uint256 amount1)
func (_Position *PositionSession) DecreaseLiquidity(params INonfungiblePositionManagerDecreaseLiquidityParams) (*types.Transaction, error) {
	return _Position.Contract.DecreaseLiquidity(&_Position.TransactOpts, params)
}

// DecreaseLiquidity is a paid mutator transaction binding the contract method 0x0c49ccbe.
//
// Solidity: function decreaseLiquidity((uint256,uint128,uint256,uint256,uint256) params) payable returns(uint256 amount0, uint256 amount1)
func (_Position *PositionTransactorSession) DecreaseLiquidity(params INonfungiblePositionManagerDecreaseLiquidityParams) (*types.Transaction, error) {
	return _Position.Contract.DecreaseLiquidity(&_Position.TransactOpts, params)
}
...
func (_Position *PositionTransactor) IncreaseLiquidity(opts *bind.TransactOpts, params INonfungiblePositionManagerIncreaseLiquidityParams) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "increaseLiquidity", params)
}

// IncreaseLiquidity is a paid mutator transaction binding the contract method 0x219f5d17.
//
// Solidity: function increaseLiquidity((uint256,uint256,uint256,uint256,uint256,uint256) params) payable returns(uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionSession) IncreaseLiquidity(params INonfungiblePositionManagerIncreaseLiquidityParams) (*types.Transaction, error) {
	return _Position.Contract.IncreaseLiquidity(&_Position.TransactOpts, params)
}

// IncreaseLiquidity is a paid mutator transaction binding the contract method 0x219f5d17.
//
// Solidity: function increaseLiquidity((uint256,uint256,uint256,uint256,uint256,uint256) params) payable returns(uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionTransactorSession) IncreaseLiquidity(params INonfungiblePositionManagerIncreaseLiquidityParams) (*types.Transaction, error) {
	return _Position.Contract.IncreaseLiquidity(&_Position.TransactOpts, params)
}
...
func (_Position *PositionTransactor) Mint(opts *bind.TransactOpts, params INonfungiblePositionManagerMintParams) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "mint", params)
}

// Mint is a paid mutator transaction binding the contract method 0x88316456.
//
// Solidity: function mint((address,address,uint24,int24,int24,uint256,uint256,uint256,uint256,address,uint256) params) payable returns(uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionSession) Mint(params INonfungiblePositionManagerMintParams) (*types.Transaction, error) {
	return _Position.Contract.Mint(&_Position.TransactOpts, params)
}

// Mint is a paid mutator transaction binding the contract method 0x88316456.
//
// Solidity: function mint((address,address,uint24,int24,int24,uint256,uint256,uint256,uint256,address,uint256) params) payable returns(uint256 tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionTransactorSession) Mint(params INonfungiblePositionManagerMintParams) (*types.Transaction, error) {
	return _Position.Contract.Mint(&_Position.TransactOpts, params)
}
...
func (_Position *PositionTransactor) Multicall(opts *bind.TransactOpts, data [][]byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "multicall", data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) payable returns(bytes[] results)
func (_Position *PositionSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _Position.Contract.Multicall(&_Position.TransactOpts, data)
}

// Multicall is a paid mutator transaction binding the contract method 0xac9650d8.
//
// Solidity: function multicall(bytes[] data) payable returns(bytes[] results)
func (_Position *PositionTransactorSession) Multicall(data [][]byte) (*types.Transaction, error) {
	return _Position.Contract.Multicall(&_Position.TransactOpts, data)
}
...
func (_Position *PositionTransactor) Permit(opts *bind.TransactOpts, spender common.Address, tokenId *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "permit", spender, tokenId, deadline, v, r, s)
}

// Permit is a paid mutator transaction binding the contract method 0x7ac2ff7b.
//
// Solidity: function permit(address spender, uint256 tokenId, uint256 deadline, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionSession) Permit(spender common.Address, tokenId *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.Permit(&_Position.TransactOpts, spender, tokenId, deadline, v, r, s)
}

// Permit is a paid mutator transaction binding the contract method 0x7ac2ff7b.
//
// Solidity: function permit(address spender, uint256 tokenId, uint256 deadline, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionTransactorSession) Permit(spender common.Address, tokenId *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.Permit(&_Position.TransactOpts, spender, tokenId, deadline, v, r, s)
}
...
func (_Position *PositionTransactor) RefundETH(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "refundETH")
}

// RefundETH is a paid mutator transaction binding the contract method 0x12210e8a.
//
// Solidity: function refundETH() payable returns()
func (_Position *PositionSession) RefundETH() (*types.Transaction, error) {
	return _Position.Contract.RefundETH(&_Position.TransactOpts)
}

// RefundETH is a paid mutator transaction binding the contract method 0x12210e8a.
//
// Solidity: function refundETH() payable returns()
func (_Position *PositionTransactorSession) RefundETH() (*types.Transaction, error) {
	return _Position.Contract.RefundETH(&_Position.TransactOpts)
}
...
func (_Position *PositionTransactor) SafeTransferFrom0(opts *bind.TransactOpts, from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "safeTransferFrom0", from, to, tokenId, _data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes _data) returns()
func (_Position *PositionSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Position.Contract.SafeTransferFrom0(&_Position.TransactOpts, from, to, tokenId, _data)
}

// SafeTransferFrom0 is a paid mutator transaction binding the contract method 0xb88d4fde.
//
// Solidity: function safeTransferFrom(address from, address to, uint256 tokenId, bytes _data) returns()
func (_Position *PositionTransactorSession) SafeTransferFrom0(from common.Address, to common.Address, tokenId *big.Int, _data []byte) (*types.Transaction, error) {
	return _Position.Contract.SafeTransferFrom0(&_Position.TransactOpts, from, to, tokenId, _data)
}
...
func (_Position *PositionTransactor) SelfPermit(opts *bind.TransactOpts, token common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "selfPermit", token, value, deadline, v, r, s)
}

// SelfPermit is a paid mutator transaction binding the contract method 0xf3995c67.
//
// Solidity: function selfPermit(address token, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionSession) SelfPermit(token common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermit(&_Position.TransactOpts, token, value, deadline, v, r, s)
}

// SelfPermit is a paid mutator transaction binding the contract method 0xf3995c67.
//
// Solidity: function selfPermit(address token, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionTransactorSession) SelfPermit(token common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermit(&_Position.TransactOpts, token, value, deadline, v, r, s)
}
...
func (_Position *PositionTransactor) SelfPermitAllowed(opts *bind.TransactOpts, token common.Address, nonce *big.Int, expiry *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "selfPermitAllowed", token, nonce, expiry, v, r, s)
}

// SelfPermitAllowed is a paid mutator transaction binding the contract method 0x4659a494.
//
// Solidity: function selfPermitAllowed(address token, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionSession) SelfPermitAllowed(token common.Address, nonce *big.Int, expiry *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermitAllowed(&_Position.TransactOpts, token, nonce, expiry, v, r, s)
}

// SelfPermitAllowed is a paid mutator transaction binding the contract method 0x4659a494.
//
// Solidity: function selfPermitAllowed(address token, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionTransactorSession) SelfPermitAllowed(token common.Address, nonce *big.Int, expiry *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermitAllowed(&_Position.TransactOpts, token, nonce, expiry, v, r, s)
}
...
func (_Position *PositionTransactor) SelfPermitAllowedIfNecessary(opts *bind.TransactOpts, token common.Address, nonce *big.Int, expiry *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "selfPermitAllowedIfNecessary", token, nonce, expiry, v, r, s)
}

// SelfPermitAllowedIfNecessary is a paid mutator transaction binding the contract method 0xa4a78f0c.
//
// Solidity: function selfPermitAllowedIfNecessary(address token, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionSession) SelfPermitAllowedIfNecessary(token common.Address, nonce *big.Int, expiry *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermitAllowedIfNecessary(&_Position.TransactOpts, token, nonce, expiry, v, r, s)
}

// SelfPermitAllowedIfNecessary is a paid mutator transaction binding the contract method 0xa4a78f0c.
//
// Solidity: function selfPermitAllowedIfNecessary(address token, uint256 nonce, uint256 expiry, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionTransactorSession) SelfPermitAllowedIfNecessary(token common.Address, nonce *big.Int, expiry *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermitAllowedIfNecessary(&_Position.TransactOpts, token, nonce, expiry, v, r, s)
}
...
func (_Position *PositionTransactor) SelfPermitIfNecessary(opts *bind.TransactOpts, token common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "selfPermitIfNecessary", token, value, deadline, v, r, s)
}

// SelfPermitIfNecessary is a paid mutator transaction binding the contract method 0xc2e3140a.
//
// Solidity: function selfPermitIfNecessary(address token, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionSession) SelfPermitIfNecessary(token common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermitIfNecessary(&_Position.TransactOpts, token, value, deadline, v, r, s)
}

// SelfPermitIfNecessary is a paid mutator transaction binding the contract method 0xc2e3140a.
//
// Solidity: function selfPermitIfNecessary(address token, uint256 value, uint256 deadline, uint8 v, bytes32 r, bytes32 s) payable returns()
func (_Position *PositionTransactorSession) SelfPermitIfNecessary(token common.Address, value *big.Int, deadline *big.Int, v uint8, r [32]byte, s [32]byte) (*types.Transaction, error) {
	return _Position.Contract.SelfPermitIfNecessary(&_Position.TransactOpts, token, value, deadline, v, r, s)
}
...
func (_Position *PositionTransactor) SetApprovalForAll(opts *bind.TransactOpts, operator common.Address, approved bool) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "setApprovalForAll", operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Position *PositionSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Position.Contract.SetApprovalForAll(&_Position.TransactOpts, operator, approved)
}

// SetApprovalForAll is a paid mutator transaction binding the contract method 0xa22cb465.
//
// Solidity: function setApprovalForAll(address operator, bool approved) returns()
func (_Position *PositionTransactorSession) SetApprovalForAll(operator common.Address, approved bool) (*types.Transaction, error) {
	return _Position.Contract.SetApprovalForAll(&_Position.TransactOpts, operator, approved)
}
...
func (_Position *PositionTransactor) SweepToken(opts *bind.TransactOpts, token common.Address, amountMinimum *big.Int, recipient common.Address) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "sweepToken", token, amountMinimum, recipient)
}

// SweepToken is a paid mutator transaction binding the contract method 0xdf2ab5bb.
//
// Solidity: function sweepToken(address token, uint256 amountMinimum, address recipient) payable returns()
func (_Position *PositionSession) SweepToken(token common.Address, amountMinimum *big.Int, recipient common.Address) (*types.Transaction, error) {
	return _Position.Contract.SweepToken(&_Position.TransactOpts, token, amountMinimum, recipient)
}

// SweepToken is a paid mutator transaction binding the contract method 0xdf2ab5bb.
//
// Solidity: function sweepToken(address token, uint256 amountMinimum, address recipient) payable returns()
func (_Position *PositionTransactorSession) SweepToken(token common.Address, amountMinimum *big.Int, recipient common.Address) (*types.Transaction, error) {
	return _Position.Contract.SweepToken(&_Position.TransactOpts, token, amountMinimum, recipient)
}
...
func (_Position *PositionTransactor) UniswapV3MintCallback(opts *bind.TransactOpts, amount0Owed *big.Int, amount1Owed *big.Int, data []byte) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "uniswapV3MintCallback", amount0Owed, amount1Owed, data)
}

// UniswapV3MintCallback is a paid mutator transaction binding the contract method 0xd3487997.
//
// Solidity: function uniswapV3MintCallback(uint256 amount0Owed, uint256 amount1Owed, bytes data) returns()
func (_Position *PositionSession) UniswapV3MintCallback(amount0Owed *big.Int, amount1Owed *big.Int, data []byte) (*types.Transaction, error) {
	return _Position.Contract.UniswapV3MintCallback(&_Position.TransactOpts, amount0Owed, amount1Owed, data)
}

// UniswapV3MintCallback is a paid mutator transaction binding the contract method 0xd3487997.
//
// Solidity: function uniswapV3MintCallback(uint256 amount0Owed, uint256 amount1Owed, bytes data) returns()
func (_Position *PositionTransactorSession) UniswapV3MintCallback(amount0Owed *big.Int, amount1Owed *big.Int, data []byte) (*types.Transaction, error) {
	return _Position.Contract.UniswapV3MintCallback(&_Position.TransactOpts, amount0Owed, amount1Owed, data)
}
...
func (_Position *PositionTransactor) UnwrapWETH9(opts *bind.TransactOpts, amountMinimum *big.Int, recipient common.Address) (*types.Transaction, error) {
	return _Position.contract.Transact(opts, "unwrapWETH9", amountMinimum, recipient)
}

// UnwrapWETH9 is a paid mutator transaction binding the contract method 0x49404b7c.
//
// Solidity: function unwrapWETH9(uint256 amountMinimum, address recipient) payable returns()
func (_Position *PositionSession) UnwrapWETH9(amountMinimum *big.Int, recipient common.Address) (*types.Transaction, error) {
	return _Position.Contract.UnwrapWETH9(&_Position.TransactOpts, amountMinimum, recipient)
}

// UnwrapWETH9 is a paid mutator transaction binding the contract method 0x49404b7c.
//
// Solidity: function unwrapWETH9(uint256 amountMinimum, address recipient) payable returns()
func (_Position *PositionTransactorSession) UnwrapWETH9(amountMinimum *big.Int, recipient common.Address) (*types.Transaction, error) {
	return _Position.Contract.UnwrapWETH9(&_Position.TransactOpts, amountMinimum, recipient)
}
...
func (_Position *PositionTransactor) Receive(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Position.contract.RawTransact(opts, nil) // calldata is disallowed for receive function
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_Position *PositionSession) Receive() (*types.Transaction, error) {
	return _Position.Contract.Receive(&_Position.TransactOpts)
}

// Receive is a paid mutator transaction binding the contract receive function.
//
// Solidity: receive() payable returns()
func (_Position *PositionTransactorSession) Receive() (*types.Transaction, error) {
	return _Position.Contract.Receive(&_Position.TransactOpts)
}
...
// PositionCollectIterator is returned from FilterCollect and is used to iterate over the raw logs and unpacked data for Collect events raised by the Position contract.
type PositionCollectIterator struct {
	Event *PositionCollect // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PositionCollectIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PositionCollectIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PositionCollectIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PositionCollect represents a Collect event raised by the Position contract.
type PositionCollect struct {
	TokenId   *big.Int
	Recipient common.Address
	Amount0   *big.Int
	Amount1   *big.Int
...
func (_Position *PositionFilterer) FilterCollect(opts *bind.FilterOpts, tokenId []*big.Int) (*PositionCollectIterator, error) {
	...
	logs, sub, err := _Position.contract.FilterLogs(opts, "Collect", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &PositionCollectIterator{contract: _Position.contract, event: "Collect", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event Collect(uint256 indexed tokenId, address recipient, uint256 amount0, uint256 amount1)
func (_Position *PositionFilterer) WatchCollect(opts *bind.WatchOpts, sink chan<- *PositionCollect, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Position.contract.WatchLogs(opts, "Collect", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PositionCollect)
				if err := _Position.contract.UnpackLog(event, "Collect", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event Collect(uint256 indexed tokenId, address recipient, uint256 amount0, uint256 amount1)
func (_Position *PositionFilterer) ParseCollect(log types.Log) (*PositionCollect, error) {
	event := new(PositionCollect)
	if err := _Position.contract.UnpackLog(event, "Collect", log); err != nil {
		return nil, err
	}
...
// PositionDecreaseLiquidityIterator is returned from FilterDecreaseLiquidity and is used to iterate over the raw logs and unpacked data for DecreaseLiquidity events raised by the Position contract.
type PositionDecreaseLiquidityIterator struct {
	Event *PositionDecreaseLiquidity // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PositionDecreaseLiquidityIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PositionDecreaseLiquidity)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PositionDecreaseLiquidityIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PositionDecreaseLiquidityIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PositionDecreaseLiquidity represents a DecreaseLiquidity event raised by the Position contract.
type PositionDecreaseLiquidity struct {
	TokenId   *big.Int
	Liquidity *big.Int
	Amount0   *big.Int
	Amount1   *big.Int
...
func (_Position *PositionFilterer) FilterDecreaseLiquidity(opts *bind.FilterOpts, tokenId []*big.Int) (*PositionDecreaseLiquidityIterator, error) {
	...
	logs, sub, err := _Position.contract.FilterLogs(opts, "DecreaseLiquidity", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &PositionDecreaseLiquidityIterator{contract: _Position.contract, event: "DecreaseLiquidity", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event DecreaseLiquidity(uint256 indexed tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionFilterer) WatchDecreaseLiquidity(opts *bind.WatchOpts, sink chan<- *PositionDecreaseLiquidity, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Position.contract.WatchLogs(opts, "DecreaseLiquidity", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PositionDecreaseLiquidity)
				if err := _Position.contract.UnpackLog(event, "DecreaseLiquidity", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event DecreaseLiquidity(uint256 indexed tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionFilterer) ParseDecreaseLiquidity(log types.Log) (*PositionDecreaseLiquidity, error) {
	event := new(PositionDecreaseLiquidity)
	if err := _Position.contract.UnpackLog(event, "DecreaseLiquidity", log); err != nil {
		return nil, err
	}
...
// PositionIncreaseLiquidityIterator is returned from FilterIncreaseLiquidity and is used to iterate over the raw logs and unpacked data for IncreaseLiquidity events raised by the Position contract.
type PositionIncreaseLiquidityIterator struct {
	Event *PositionIncreaseLiquidity // Event containing the contract specifics and raw log
...
// are any more events found. In case of a retrieval or parsing error, false is
// returned and Error() can be queried for the exact failure.
func (it *PositionIncreaseLiquidityIterator) Next() bool {
	// If the iterator failed, stop iterating
	if it.fail != nil {
		return false
	}
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(PositionIncreaseLiquidity)
			if err := it.contract.UnpackLog(it.Event, it.event, log); err != nil {
				it.fail = err
				return false
			}
...
// Error returns any retrieval or parsing error occurred during filtering.
func (it *PositionIncreaseLiquidityIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *PositionIncreaseLiquidityIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// PositionIncreaseLiquidity represents a IncreaseLiquidity event raised by the Position contract.
type PositionIncreaseLiquidity struct {
	TokenId   *big.Int
	Liquidity *big.Int
	Amount0   *big.Int
	Amount1   *big.Int
...
func (_Position *PositionFilterer) FilterIncreaseLiquidity(opts *bind.FilterOpts, tokenId []*big.Int) (*PositionIncreaseLiquidityIterator, error) {
	...
	logs, sub, err := _Position.contract.FilterLogs(opts, "IncreaseLiquidity", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return &PositionIncreaseLiquidityIterator{contract: _Position.contract, event: "IncreaseLiquidity", logs: logs, sub: sub}, nil
}
...
//
// Solidity: event IncreaseLiquidity(uint256 indexed tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionFilterer) WatchIncreaseLiquidity(opts *bind.WatchOpts, sink chan<- *PositionIncreaseLiquidity, tokenId []*big.Int) (event.Subscription, error) {
	...
	logs, sub, err := _Position.contract.WatchLogs(opts, "IncreaseLiquidity", tokenIdRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				// New log arrived, parse the event and forward to the user
				event := new(PositionIncreaseLiquidity)
				if err := _Position.contract.UnpackLog(event, "IncreaseLiquidity", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event IncreaseLiquidity(uint256 indexed tokenId, uint128 liquidity, uint256 amount0, uint256 amount1)
func (_Position *PositionFilterer) ParseIncreaseLiquidity(log types.Log) (*PositionIncreaseLiquidity, error) {
	event := new(PositionIncreaseLiquidity)
	if err := _Position.contract.UnpackLog(event, "IncreaseLiquidity", log); err != nil {
		return nil, err
	}
