...
//go:generate abigen --abi ./contract/sound.abi --pkg contract --type Sound --out ./contract/sound.go
...
var (
	...
	EventSoundEditionCreated = common.HexToHash("0x405098db99342b699216d8150e930dbbf2f686f5a43485aed1e69219dafd4935")

	MintContractAddress        = common.HexToAddress("0xeae422887230C0FFB91Fd8F708f5fdD354C92F2F")
	SongCreatorContractAddress = common.HexToAddress("0xaef3e8c8723d9c31863be8de54df2668ef7c4b89")
)
